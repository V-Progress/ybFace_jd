...
public class MIPSCamera {
    ...
    //    public static int CameraFacing = Camera.CameraInfo.CAMERA_FACING_FRONT;//前置
    public static int CameraFacing = Camera.CameraInfo.CAMERA_FACING_BACK;//将摄像头调整为后置
            ...
            if (info.facing == mCameraFacing) {
                ...
                mCamera.setErrorCallback(new Camera.ErrorCallback() {
                    ...
                    public void onError(int error, Camera camera) {
                        EventBus.getDefault().post(new CameraError(error));
                    }
                });
                break;
            }
    ...
    public void initParameters() {
        ...
        try {
            Parameters parameters = mCamera.getParameters();// TODO: 2019/5/13 报错 java.lang.RuntimeException: getParameters failed (empty parameters)
