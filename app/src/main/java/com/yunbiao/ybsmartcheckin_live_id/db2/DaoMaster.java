...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        ...
        MultiTotalDao.createTable(db, ifNotExists);
        SignDao.createTable(db, ifNotExists);
        UserDao.createTable(db, ifNotExists);
        VisitorDao.createTable(db, ifNotExists);
        ExceptionDao.createTable(db, ifNotExists);
    }
    ...
    public static void dropAllTables(Database db, boolean ifExists) {
        ...
        MultiTotalDao.dropTable(db, ifExists);
        SignDao.dropTable(db, ifExists);
        UserDao.dropTable(db, ifExists);
        VisitorDao.dropTable(db, ifExists);
        ExceptionDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(MultiTotalDao.class);
