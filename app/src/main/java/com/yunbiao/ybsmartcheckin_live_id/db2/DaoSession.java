...
import com.yunbiao.ybsmartcheckin_live_id.db2.ExceptionDao;
...
public class DaoSession extends AbstractDaoSession {
    ...
    public DaoSession(Database db, IdentityScopeType type, Map<Class<? extends AbstractDao<?, ?>>, DaoConfig>
        ...
        exceptionDaoConfig = daoConfigMap.get(ExceptionDao.class).clone();
        exceptionDaoConfig.initIdentityScope(type);
        ...
        exceptionDao = new ExceptionDao(exceptionDaoConfig, this);
        ...
        registerDao(Exception.class, exceptionDao);
    }
    ...
    public void clear() {
        ...
        exceptionDaoConfig.clearIdentityScope();
    }
