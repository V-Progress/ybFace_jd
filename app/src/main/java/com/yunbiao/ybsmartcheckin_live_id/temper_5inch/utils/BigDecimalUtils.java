...
public class BigDecimalUtils {
    ...
    public static BigDecimal add(int v1, int v2, int scale) {
        if (scale < 0) {
            scale = 0;
        }
        BigDecimal b1 = new BigDecimal(v1);
    ...
    public static BigDecimal add(float v1, float v2, int scale) {
        if (scale < 0) {
            scale = 0;
        }
        BigDecimal b1 = new BigDecimal(v1);
    ...
    public static BigDecimal sub(int v1, int v2, int scale) {
        if (scale < 0) {
            scale = 0;
        }
        BigDecimal b1 = new BigDecimal(v1);
    ...
    public static BigDecimal sub(float v1, float v2, int scale) {
        if (scale < 0) {
            scale = 0;
        }
        BigDecimal b1 = new BigDecimal(v1);
    ...
    public static BigDecimal mul(int v1, int v2, int scale) {
        if (scale < 0) {
            scale = 0;
        }
        BigDecimal b1 = new BigDecimal(v1);
    ...
    public static BigDecimal mul(float v1, float v2, int scale) {
        if (scale < 0) {
            scale = 0;
        }
        BigDecimal b1 = new BigDecimal(v1);
