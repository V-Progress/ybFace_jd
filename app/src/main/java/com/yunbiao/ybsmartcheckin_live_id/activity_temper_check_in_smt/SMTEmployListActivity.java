...
public class SMTEmployListActivity extends SMTBaseActivity implements EmployAdapter.EmpOnDeleteListener, EmployAdapter.EmpOnEditListener, View.OnClickListener {
    ...
    protected int getLayout() {
        return R.layout.activity_smt_employlist;
    }
    ...
    public void queryClick(View view){
        ...
        if(TextUtils.isEmpty(queryStr)){
            UIUtils.showTitleTip(this, APP.getContext().getResources().getString(R.string.employ_list_please_input_name));
            return;
        }
        int index = -1;
        ...
        if(index == -1){
            UIUtils.showTitleTip(this,APP.getContext().getResources().getString(R.string.employ_list_no_this_person));
            return;
        }
    ...
    public void itemEditClick(View v, final int postion) {
        showDialog(getString(R.string.employ_list_confirm_edit), new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                intent.putExtra(SMTEditEmployActivity.KEY_ID, employList.get(postion).getId());
                intent.putExtra(SMTEditEmployActivity.KEY_TYPE, SMTEditEmployActivity.TYPE_EDIT);
