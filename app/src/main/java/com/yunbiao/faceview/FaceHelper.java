...
public class FaceHelper {
    ...
    private FaceHelper(Builder builder) {
        ...
        if(builder.imgQueueSize > 0){
            ...
            Log.e(TAG, "imgThread num must > 0,now using default value:" + imgQueueSize);
        }
        imgThreadQueue = new LinkedBlockingQueue<>(imgQueueSize);
        imgExecutor = new ThreadPoolExecutor(1, imgQueueSize, 0, TimeUnit.MILLISECONDS, imgThreadQueue);
    }
...
//                    Log.i(TAG, "onPreviewFrame: ft costTime = " + (System.currentTimeMillis() - ftStartTime) + "ms");
    ...
    public static final class Builder {
        ...
        public Builder imgQueueSize(int val) {
            imgQueueSize = val;
            return this;
        }
